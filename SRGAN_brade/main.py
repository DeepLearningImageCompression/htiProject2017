...
Flags.DEFINE_string('output_dir', './checkpoint', 'The output directory of the checkpoint')
...
Flags.DEFINE_string('checkpoint', './checkpoint/model-192000', 'If provided, the weight will be restored from the provided checkpoint')
...
Flags.DEFINE_integer('batch_size', 8, 'Batch size of the input batch')
Flags.DEFINE_string('input_dir_LR', '../Banques/test_LR', 'The directory of the input resolution input data')
Flags.DEFINE_string('input_dir_HR', '../Banques/test_HR', 'The directory of the high resolution input data')
...
Flags.DEFINE_integer('max_iter', 2000, 'The max iteration of the training')
Flags.DEFINE_integer('display_freq', 200, 'The diplay frequency of the training process')
Flags.DEFINE_integer('summary_freq', 1000, 'The frequency of writing summary')
Flags.DEFINE_integer('save_freq', 500, 'The frequency of saving images')
