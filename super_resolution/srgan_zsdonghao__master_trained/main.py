...
def evaluate(road, imageName):
    ## create folders to save result images
    save_dir = ".\\results\{}".format(tl.global_flag['mode'])
    ...
    valid_lr_img = get_imgs_fn(imageName, road)  # if you want to test your own image
    # valid_hr_img = get_imgs_fn(imageName, 'imageName\\')  # if you want to test your own image
...
if __name__ == '__main__':
    ...
    if tl.global_flag['mode'] == 'srgan':
        ...
        road = "D:\datasets\im_test_lr\\"
        imageName = "COCO_val2014_000000000073"
        evaluate(road, imageName)
    else:
